...
nom=(char*)malloc(query_size+1000);
mdp=(char*)malloc(query_size+1000);
mdpsave=(char*)malloc(query_size+1000);
code=(char*)malloc(query_size+1000);
ami=(char*)malloc(query_size+1000);
...
<body>\n\
Photo de votre avatar :<br><br>\n\
<form action=\"/cgi-bin/reflex_douploadavatar.cgi\" method=\"post\" enctype=\"multipart/form-data\">\n\
