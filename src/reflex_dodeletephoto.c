	...
	if(db_ntuples(result)==0)
		...
		if(db_ntuples(result)==0)
			...
			if(db_ntuples(result)==0)
         	...
         	if(success==1)
         		{
         		sprintf(query,"delete from photo where compte=\'%s\' and album=\'%s\' and digest=\'%s\';",nom,album,digest);
         		db_query(handler,query);
         		db_clear_result(result);
...
<body>\n\
   <div data-role=\"page\" data-theme=\"b\">\n\
      ...
      <div data-role=\"navbar\">\n\
            <ul>\n\
               <li>\n\
                  ...
                  <button type=\"submit\" data-mini=\"false\" data-inline=\"false\" data-theme=\"b\" data-icon=\"back\" class=\"ui-shadow\" style=\"max-width:100%%; border: 0; object-fit: contain;\">Retour à l'album</button>\n\
                  </form>\n\
               </li>\n\
            </ul>\n\
         </div>\n\
      ...
      %s",nom,mdp,code,nom,album,reponse);
printf("</div>\n\
