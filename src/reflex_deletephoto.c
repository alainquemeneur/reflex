...
tamb(code);
get_chaine(envoi,2,album);
tamb(album);
get_chaine(envoi,1,digest);
tamb(digest);
strcpy(mdpsav,mdp);
hache(mdp);
...
<body>\n\
   <div data-role=\"page\" data-theme=\"b\">\n\
      ...
      Etes-vous sûr d'effacer cette photo ?\n\
      <form action=\"/cgi-bin/reflex_dodeletephoto.cgi\" method=\"post\" id=\"form-deletephoto\" data-transition=\"none\" data-rel=\"dialog\">\n\
<input type=\"hidden\" name=\"txt-compte\" id=\"txt-compte\" value=\"%s\">\n\
<input type=\"hidden\" name=\"txt-password\" id=\"txt-password\" value=\"%s\">\n\
<input type=\"hidden\" name=\"txt-code\" id=\"txt-code\" value=\"%s\">\n\
<input type=\"hidden\" name=\"txt-album\" id=\"txt-album\" value=\"%s\">\n\
<input type=\"hidden\" name=\"txt-digest\" id=\"txt-digest\" value=\"%s\">\n\
<button type=\"submit\" data-mini=\"false\" data-inline=\"false\" data-theme=\"c\" data-icon=\"delete\" class=\"ui-shadow\" style=\"max-width:100%%; border: 0; object-fit: contain;\">Confirmer la suppression</button>\n\
</form>\n",nom,mdp,code,nom,nom,mdp,code,album,digest);
printf("</div>\n\
