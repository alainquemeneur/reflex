...
if(success==1)
	...
	printf("<div data-role=\"navbar\">\n\
      ...
      <form autocomplete=\"off\" action=\"/cgi-bin/reflex_dodeletealbum.cgi\" method=\"post\" id=\"form\" data-transition=\"none\" data-rel=\"dialog\">\n\
      		<input type=\"hidden\" name=\"txt-compte\" id=\"txt-compte\" value=\"%s\">\n\
            <input type=\"hidden\" name=\"txt-password\" id=\"txt-password\" value=\"%s\">\n\
            <input type=\"hidden\" name=\"txt-code\" id=\"txt-code\" value=\"%s\">\n\
            <fieldset data-role=\"controlgroup\">\n\
            <legend>Nom de l'album à supprimer</legend>\n",nom,mdp,code,nom,nom,mdp,code);
            ...
            <label for=\"radio-choice-r%d\">%s (%s)</label>\n",i,reponse,i,reponse,reponse2);
					else printf("<input type=\"radio\" name=\"radio-choice-r\" id=\"radio-choice-r%d\" value=\"%s\" data-theme=\"b\">\n\
            <label for=\"radio-choice-r%d\">%s (%s)</label>\n",i,reponse,i,reponse,reponse2);
					}
				db_clear_result(result);
				printf("</fieldset>\n\
            <button type=\"submit\" data-mini=\"false\" data-inline=\"false\" data-theme=\"c\" data-icon=\"delete\">Supprimer l'album</button>\n\
         </form>\n\
      </div>\n\
